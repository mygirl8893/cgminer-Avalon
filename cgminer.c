...
static struct opt_table opt_config_table[] = {
	...
	OPT_WITH_ARG("--avalon7-temp",
		     set_int_22_to_75, opt_show_intval, &opt_avalon7_temp_target,
		     "Set Avalon7 target temperature"),
	OPT_WITH_ARG("--avalon7-cutoff",
		     set_int_42_to_85, opt_show_intval, &opt_avalon7_overheat,
		     "Set Avalon7 overheat cut off temperature"),
	...
	OPT_WITH_ARG("--avalon7-ntime-offset",
		     opt_set_intval, opt_show_intval, &opt_avalon7_ntime_offset,
		     "Set Avalon7 MM ntime rolling max offset"),
	OPT_WITH_ARG("--avalon7-aucspeed",
		     opt_set_intval, opt_show_intval, &opt_avalon7_aucspeed,
		     "Set Avalon7 AUC IIC bus speed"),
	...
	OPT_WITH_ARG("--avalon7-smart-speed",
		     ...
		     "Set Avalon7 smart speed, range 0-3. 0 means Disable"),
	...
	OPT_WITH_ARG("--avalon7-freqadj-time",
		     ...
		     "Set Avalon7 check interval when run in AVA4_FREQ_TEMPADJ_MODE"),
	OPT_WITH_ARG("--avalon7-delta-temp",
		     opt_set_intval, opt_show_intval, &opt_avalon7_delta_temp,
		     "Set Avalon7 delta temperature when reset freq in AVA4_FREQ_TEMPADJ_MODE"),
	OPT_WITH_ARG("--avalon7-delta-freq",
		     opt_set_intval, opt_show_intval, &opt_avalon7_delta_freq,
		     "Set Avalon7 delta freq when adjust freq in AVA4_FREQ_TEMPADJ_MODE"),
	OPT_WITH_ARG("--avalon7-freqadj-temp",
		     opt_set_intval, opt_show_intval, &opt_avalon7_freqadj_temp,
		     "Set Avalon7 check temperature when run into AVA4_FREQ_TEMPADJ_MODE"),
#endif
#ifdef USE_AVALON_MINER
