...
static struct opt_table opt_config_table[] = {
	...
	OPT_WITH_CBARG("--avalon2-freq",
		     ...
		     "Set frequency for Avalon2, 1 to 2 values, example: 410:400:390"),
	...
	OPT_WITH_ARG("--avalon2-aucspeed",
		     ...
		     "Set Avalon2 AUC IIC bus speed"),
	OPT_WITH_ARG("--avalon2-aucxdelay",
		     opt_set_intval, opt_show_intval, &opt_avalon2_aucxdelay,
		     "Set Avalon2 AUC IIC xfer read delay, 4800 ~= 1ms"),
#endif
#ifdef USE_BAB
