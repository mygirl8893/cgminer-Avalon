...
struct avalon7_info {
	...
	uint32_t set_frequency[AVA7_DEFAULT_MODULARS][AVA7_DEFAULT_MINER_MAX];
	uint32_t get_frequency[AVA7_DEFAULT_MODULARS][AVA7_DEFAULT_MINER_MAX];

	int led_red[AVA7_DEFAULT_MODULARS];
	uint8_t cutoff[AVA7_DEFAULT_MODULARS];

	int pll_info[AVA7_DEFAULT_MODULARS][AVA7_DEFAULT_MINER_MAX][AVA7_DEFAULT_PLL_CNT];
	...
	uint32_t error_crc[AVA7_DEFAULT_MODULARS][AVA7_DEFAULT_MINER_MAX];
